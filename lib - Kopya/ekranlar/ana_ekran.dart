...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  void _showProfileSheet() {
    // DÜZELTME BURADA: Temayı kontrol edip rengi manuel atıyoruz.
    // cardTheme bazen null gelebildiği için işimizi garantiye alıyoruz.
    ...
    showModalBottomSheet(
      ...
      builder: (context) => Container(
        ...
        decoration: BoxDecoration(
          color: sheetColor, // Artık doğru renk (Koyu veya Beyaz)
        ...
        child: Column(
          children: [
            ...
            Expanded(
              child: PageProfil(userName: widget.userName, onLogout: _logout),
            ),
          ],
        ),
      ),
  ...
  Widget build(BuildContext context) {
    // Tema renklerini al
    // cardTheme yerine doğrudan koyu mod kontrolü yapıyoruz ki garanti olsun.
    final isDark = Theme.of(context).brightness == Brightness.dark;
